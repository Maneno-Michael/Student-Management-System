        ...
        <div class="h-screen">
                ...
                <div class="flex gap-20 items-center justify-center w-full">
                    ...
                    <div class="flex gap-6">
                        <svg
                            ...
                            stroke-width="1.5"
                            stroke="currentColor"
                            class="size-6 text-gray-600 cursor-pointer hover:text-black"
                        >
                            <path
                                stroke-linecap="round"
                                stroke-linejoin="round"
                        ...
                        <svg
                            ...
                            stroke-width="1.5"
                            stroke="currentColor"
                            class="size-5 text-gray-600 cursor-pointer hover:text-black"
                        >
                            <path
                                stroke-linecap="round"
                                stroke-linejoin="round"
                    ...
                    <div class="flex gap-5">
                        <div class="flex gap-3">
                            ...
                            <div class="text-gray-500 text-sm my-2">
                                <p class="text-black font-bold">Call Now</p>
                                <p>+254 718 776 401</p>
                            </div>
                        </div>
                        <div class="flex gap-3">
                            ...
                            <div class="text-gray-500 text-sm my-2">
                                <p class="text-black font-bold">E-mail Us</p>
                        ...
                        <div class="flex gap-2">
                            ...
                            <div class="text-gray-400 text-sm my-2">
                                <p class="text-black font-bold">Our Location</p>
                                <p>Bungoma Town</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-[#29c190] shadow-lg h-20 flex">
                <div class="flex justify-end items-center w-full mx-10">
                    <nav
                        v-if="canLogin"
                        class="-mx-3 flex gap-5 flex-1 justify-end"
                    >
                        <Link
